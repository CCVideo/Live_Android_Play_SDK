...
public class ReplayMixChatAdapter extends RecyclerView.Adapter<ReplayMixChatAdapter.ChatViewHolder> {
    ...
    @Override
    public ReplayMixChatAdapter.ChatViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = null;
        if (viewType == selfType) {
            // 展示自己发出去的公聊
            itemView = mInflater.inflate(R.layout.live_portrait_chat_single, parent, false);
            return new ReplayMixChatAdapter.ChatViewHolder(itemView);
    ...
    @Override
    public void onBindViewHolder(ReplayMixChatAdapter.ChatViewHolder holder, int position) {
